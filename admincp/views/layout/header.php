...
<head>
    ...
    <meta name="keywords" content="Admincp-SmartShop" />
    ...
    <!-- Chartinator  -->
    <script src="views/js/chartinator.js" ></script>
        ...
        <div class="mother-grid-inner">
            ...
            <div class="header-main">
                <div class="header-left">
                    <div class="logo-name">
                        <a href="index.php"> <h1>SmartShop</h1>
                    ...
                    <div class="profile_details_left"><!--notifications of menu start -->
                        <ul class="nofitications-dropdown">
                            <li class="dropdown head-dpdn">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-envelope"></i><span class="badge"><?php echo $all_orders; ?></span></a>
                            </li>
                        </ul>
                        <div class="clearfix"> </div>
                    </div>
                            ...
                            <li class="dropdown profile_details_drop">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">
                                        <span class="prfil-img"><img src="views/images/p1.png" alt=""> </span>
                                        <div class="user-name">
